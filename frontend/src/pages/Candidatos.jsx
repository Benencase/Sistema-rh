...
      }}
    >
      <h1 style={{ color: "#343A40" }}>Gestão de Candidatos</h1>
...
            color: abaAtiva === "form" ? "#fff" : "#343A40",
            border: "none",
            padding: "10px 20px",
            borderRadius: 4,
            cursor: "pointer",
...
            color: abaAtiva === "curriculo" ? "#fff" : "#343A40",
            border: "none",
            padding: "10px 20px",
            borderRadius: 4,
            cursor: "pointer",
...
              </button>
            )}
            {editandoId !== null && observacoesEntrevista && (
              <button
                type="button"
                onClick={handleDownloadCurriculo}
                style={{ marginLeft: 10, padding: "10px 20px", background: '#28a745', color: '#fff', border: 'none', borderRadius: 4, cursor: 'pointer' }}
              >
                Baixar Currículo
              </button>
            )}
